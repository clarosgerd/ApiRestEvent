...
<table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.15);">
  ...
  <tr><td style="background:#607080;padding:28px 32px;text-align:center;">
    <h1 style="color:#ffffff;font-size:22px;margin:0 0 4px;">Registration Cancelled</h1>
  ...
  <tr><td style="padding:18px 32px;text-align:center;background:#f4f8fb;">
    <p style="color:#607080;font-size:11px;margin:0 0 2px;text-transform:uppercase;letter-spacing:1px;">Reference Number</p>
  ...
  <tr><td style="padding:24px 32px;">
    <p style="font-size:14px;color:#1a2a3a;margin:0 0 12px;">
      Your registration for <strong>{{ $registration->evento_nombre }}</strong> was not paid within
      the required time, so your spot has been reassigned and this registration is now
