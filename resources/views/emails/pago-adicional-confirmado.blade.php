...
<table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.15);">
  ...
  <tr><td style="background:#022858;padding:28px 32px;text-align:center;">
    <h1 style="color:#ffffff;font-size:22px;margin:0 0 4px;">Pago adicional confirmado</h1>
  ...
  <tr><td style="padding:24px 32px;">
    <p style="font-size:14px;color:#1a2a3a;margin:0 0 16px;">
      Confirmamos tu pago adicional para modificar tu inscripción — el cambio ya se aplicó.
    </p>
    <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;color:#1a2a3a;">
      <tr>
        <td style="padding:6px 0;color:#607080;width:150px;">Evento</td>
        <td style="padding:6px 0;font-weight:600;">{{ $registration->evento_nombre }}</td>
      </tr>
      <tr>
        <td style="padding:6px 0;color:#607080;">Monto adicional cobrado</td>
        <td style="padding:6px 0;font-weight:700;color:#022858;">
          {{ $pago->moneda_pago === 'USD' ? 'US$' : 'Bs' }}{{ number_format((float) $pago->monto, 2) }}
        </td>
      </tr>
      <tr>
        <td style="padding:6px 0;color:#607080;">Método de pago</td>
        <td style="padding:6px 0;">QR (SIP)</td>
      </tr>
      <tr>
        <td style="padding:6px 0;color:#607080;">Fecha de confirmación</td>
        <td style="padding:6px 0;">
          {{ ($pago->paid_at ?? now())->locale('es')->translatedFormat('d \d\e F \d\e Y · h:i A') }}
        </td>
      </tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:20px 32px;">
    <p style="font-size:12px;font-weight:700;color:#022858;text-transform:uppercase;margin:0 0 12px;">
      Tu inscripción ahora incluye
    </p>
  ...
  <tr><td style="padding:16px 32px;text-align:center;background:#f4f8fb;">
    <p style="font-size:11px;color:#607080;margin:0;">
      Guarda este correo como comprobante del pago adicional.<br>
