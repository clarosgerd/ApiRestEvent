...
<table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;color:#1a2a3a;">
  ...
  <tr><td style="padding:5px 0;color:#607080;">Cargo de servicio ({{ $feePctTexto }}%)</td><td style="padding:5px 0;text-align:right;">Bs{{ number_format((float) $totals->fee, 2) }}</td></tr>
